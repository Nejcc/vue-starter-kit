    ...
    <ModuleLayout :breadcrumbs="breadcrumbItems" :module-title="moduleTitle" :module-icon="moduleIcon" :module-items="moduleItems">
        ...
        <div class="container mx-auto py-8">
            <div class="flex flex-col space-y-6">
                <Heading variant="small" title="Localization Settings" description="Configure translation drivers, locale detection, and caching" />
                ...
                >
                    ...
                    <div class="space-y-4 rounded-lg border p-4">
                        ...
                        <div class="grid gap-2 sm:max-w-xs">
                            ...
                            <p class="text-xs text-muted-foreground">How static UI translations are loaded</p>
                    ...
                    <div class="space-y-4 rounded-lg border p-4">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center gap-3">
                                ...
                                />
                                <div>
                                    <span class="text-sm font-medium">Enable Content Translation</span>
                                    <p class="text-xs text-muted-foreground">Allow model content to be translated via the HasTranslations trait</p>
                                </div>
                            </label>
                            ...
                            <div class="grid gap-2 sm:max-w-xs">
                                ...
                                >
                                    ...
                                    <option value="polymorphic_table">Polymorphic Table</option>
                                </select>
                                <p class="text-xs text-muted-foreground">How translated content is stored</p>
                                <InputError :message="errors['content.strategy']" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 rounded-lg border p-4">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div class="grid gap-2">
                                ...
                                <p class="text-xs text-muted-foreground">How the current locale is determined from the request</p>
                                <InputError :message="errors['detection.strategy']" />
                            </div>
                            <div class="grid gap-2">
                                ...
                                <Input
                                    ...
                                    placeholder="locale"
                                />
                                <p class="text-xs text-muted-foreground">Column on users table for user_preference resolver</p>
                                <InputError :message="errors['detection.user_column']" />
                            </div>
                        </div>
                        ...
                        <div v-if="formData.detection.strategy === 'chain'" class="space-y-3">
                            ...
                            <div class="space-y-2">
                                ...
                                >
                                    ...
                                    />
                                    <span class="text-sm">{{ resolver.replace('_', ' ') }}</span>
                                </label>
                            </div>
                            <p class="text-xs text-muted-foreground">Select resolvers to try in order when using chain strategy</p>
                    ...
                    <div class="space-y-4 rounded-lg border p-4">
                        ...
                        <div class="space-y-3">
                            <label class="flex items-center gap-3">
                                ...
                                />
                                <div>
                                    <span class="text-sm font-medium">Enable Translation Cache</span>
                                    <p class="text-xs text-muted-foreground">Cache loaded translations for better performance</p>
                                </div>
                            </label>
                            ...
                            <div class="grid gap-2 sm:max-w-xs">
                                ...
                                <Input
                                    ...
                                    min="0"
                                />
                                <p class="text-xs text-muted-foreground">How long translations are cached (0 to disable TTL)</p>
