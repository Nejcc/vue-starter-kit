...
<template>
    ...
    >
        ...
        >
            <!-- Grid pattern -->
            <div
                class="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,#fff1_1px,transparent_1px),linear-gradient(to_bottom,#fff1_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_100%)]"
            />
            ...
            <div class="relative z-10 flex h-full flex-col justify-between p-10">
                ...
                <!-- Center: tagline -->
                <div class="space-y-6">
                    <h1 class="text-4xl leading-[1.1] font-extrabold tracking-tight xl:text-5xl">
                        <span class="bg-gradient-to-b from-white to-white/60 bg-clip-text text-transparent">
                            Ship your SaaS
                        </span>
                        <br />
                        <span class="bg-gradient-to-r from-[#FF2D20] via-[#ff6a5e] to-[#FF2D20] bg-clip-text text-transparent">
                            in record time
                        </span>
                    </h1>
                    <p class="max-w-sm text-sm leading-relaxed text-[#A1A09A]">
                        Auth, payments, admin panel, RBAC, audit logs, and more — all
                        wired up with TypeScript and Tailwind CSS.
                    </p>

                    <!-- Feature pills -->
                    <div class="flex flex-wrap gap-2">
                        <span
                            v-for="feature in ['Auth & 2FA', 'Payments', 'RBAC', 'Admin Panel', 'Audit Logs', 'Dark Mode']"
                            :key="feature"
